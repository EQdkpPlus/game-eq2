 ...
 */
	...
	$this->tpl->add_css("
		...
		#guild_header_banner{
			width:100%;
			height:106px;
			background: url('".$this->root_path."games/eq2/profiles/images/achievebanner.png') no-repeat scroll 0px 0px transparent;
			margin-top:20px;
		}
		#guild_emblem { 
			height:256px;
		...
		#achicon { 
			width: 56px; height: 55px; z-index: 4; background:url('".$this->root_path."games/eq2/profiles/images/achbkg.png');
		}
	");
...
# Amory Stuff
		...
		$this->tpl->assign_block_vars('totbar', array(
		'BAR'	=> $this->jquery->progressbar('totbar', 0, array('completed' => $totcount, 'total' => $tottotal,'text' => '%progress% (%percentage%)')),
		));
...
$this->tpl->assign_vars(array(
		'CLASSIC'	=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/classic.png" class="gameicon"/>',
		'SS'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/ss.png" class="gameicon"/>',
		'DOF'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/dof.png" class="gameicon"/>',
		'KOS'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/kos.png" class="gameicon"/>',
		'FD'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/fd.png" class="gameicon"/>',
		'EOF'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/eof.png" class="gameicon"/>',
		'ROK'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/rok.png" class="gameicon"/>',
		'TSO'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/tso.png" class="gameicon"/>',
		'SF'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/sf.png" class="gameicon"/>',
		'DOV'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/dov.png" class="gameicon"/>',
		'COE'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/coe.png" class="gameicon"/>',
		'TOV'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/tov.png" class="gameicon"/>',
		'AOM'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/aom.png" class="gameicon"/>',
		'AV'		=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/avatars.png" class="gameicon"/>',
		'GENERAL'	=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/general.png" class="gameicon"/>',
		'RUM'    	=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/rum.png" class="gameicon"/>',
		'TOT'    	=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/tot.png" class="gameicon"/>',
		'ZEK'    	=> '<img src="'.$this->root_path.'games/eq2/profiles/images/expansions/zek.png" class="gameicon"/>',
